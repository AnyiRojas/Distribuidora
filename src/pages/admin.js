...
const App = () => {
    ...
    const fetchPagos = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/pagos');
    ...
    const handleUpdateEstadoPago = async (id_pago, nuevoEstado) => {
        try {
            const response = await axios.put(`https://conection-ood1.onrender.com/api/pagos/${id_pago}/estado`, { estado_pago: nuevoEstado });
    ...
    const fetchUsuarios = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/usuarios');
    ...
    const handleUpdateUsuario = async (documento, updatedUsuario) => {
        ...
        try {
            const response = await axios.put(`https://conection-ood1.onrender.com/api/usuario/${documento}`, updatedUsuario);
    ...
    const handleUpdateRolUsuario = async (documento, nuevoRol) => {
        ...
        try {
            const response = await axios.put(`https://conection-ood1.onrender.com/api/usuario/${documento}/rol`, { rol_usuario: nuevoRol });
            if (response.status === 200) {
                fetchUsuarios();
    ...
    const handleToggleStatus = async (documento) => {
        ...
        try {
            const response = await axios.patch(`https://conection-ood1.onrender.com/api/usuario/${documento}/estado`);
            if (response.status === 200) {
                fetchUsuarios();
    ...
    const fetchProductos = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/productos');
    ...
    const handleUpdateProducto = async (idProducto, formData) => {
        ...
        try {
            const response = await axios.put(`https://conection-ood1.onrender.com/api/productos/${idProducto}`, formData, {
                headers: {
    ...
    const handleToggleProductStatus = async (idProducto) => {
        ...
        try {
            ...
            const response = await axios.patch(`https://conection-ood1.onrender.com/api/productos/${idProducto}/estado`, {
                estado: nuevoEstado,
            });
    ...
    const handleCreateProducto = async (event) => {
        ...
        try {
            const response = await axios.post('https://conection-ood1.onrender.com/api/productos', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
    ...
    const handleUpdateCantidad = async (idProducto, nuevaCantidad) => {
        ...
        try {
            const response = await axios.patch(`https://conection-ood1.onrender.com/api/productos/${idProducto}/cantidad`, {
    ...
    const fetchPedidos = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/pedidos'); // Cambiado a /api/pedidos
    ...
    const handleTogglePedidoStatus = async (idPedido, nuevoEstado) => {
        ...
        try {
            const response = await axios.patch(`https://conection-ood1.onrender.com/api/pedidos/${idPedido}/estado`, {
    ...
    const handleCreatePedido = async (formData) => {
        ...
        try {
            await axios.post('https://conection-ood1.onrender.com/api/pedidos', formData, {
    ...
    const handleUpdatePedido = async (formData) => {
        ...
        try {
            await axios.put(`https://conection-ood1.onrender.com/api/pedidos/${currentOrder.id_pedido}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' },
            });
            fetchPedidos();
            closeModal();
    ...
    const fetchTiposFlor = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/tipos-flor');
    ...
    const handleAddTipoFlor = async (tipoFlorData) => {
        ...
        try {
            const response = await axios.post('https://conection-ood1.onrender.com/api/tipo-flor', { nombre_tipo_flor: nombreTipoFlor });
    ...
    const handleEditTipoFlor = async (tipoFlorData) => {
        ...
        try {
            await axios.put(`https://conection-ood1.onrender.com/api/tipo-flor/${currentTipoFlor.id_tipo_flor}`, {
    ...
    const handleDeleteTipoFlor = async (id_tipo_flor) => {
        try {
            await axios.delete(`https://conection-ood1.onrender.com/api/tipo-flor/${id_tipo_flor}`);
            fetchTiposFlor();
    ...
    const fetchFechasEspeciales = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/fechas-especiales');
    ...
    const handleAddFechaEspecial = async (fechaEspecialData) => {
        try {
            ...
            await axios.post('https://conection-ood1.onrender.com/api/fechas-especiales', formData);
            fetchFechasEspeciales();
    ...
    const handleEditFechaEspecial = async (formData) => {
        ...
        try {
            await axios.put(`https://conection-ood1.onrender.com/api/fechas-especiales/${currentFechaEspecial.id_fecha_especial}`, formData);
    ...
    const handleDeleteFechaEspecial = async (id_fecha_especial) => {
        try {
            await axios.delete(`https://conection-ood1.onrender.com/api/fechas-especiales/${id_fecha_especial}`);
            fetchFechasEspeciales();
    ...
    const handleAddEvento = async (eventoData) => {
        ...
        try {
            const response = await axios.post('https://conection-ood1.onrender.com/api/eventos', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
    ...
    const handleEditEvento = async (eventoData) => {
        ...
        try {
            await axios.put(`https://conection-ood1.onrender.com/api/eventos/${currentEvento.id_evento}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
    ...
    const handleDeleteEvento = async (id_evento) => {
        try {
            await axios.delete(`https://conection-ood1.onrender.com/api/eventos/${id_evento}`);
            fetchEventos();
    ...
    const fetchOpcionesAdicionales = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/opciones-adicionales');
    ...
    const createOpcionAdicional = async (nuevaOpcion) => {
        try {
            await axios.post('https://conection-ood1.onrender.com/api/opciones-adicionales', nuevaOpcion);
            fetchOpcionesAdicionales();
            closeModal1();
    ...
    const updateOpcionAdicional = async (id_opcion, nuevaOpcion) => {
        try {
            ...
            await axios.put(`https://conection-ood1.onrender.com/api/opciones-adicionales/${id_opcion}`, {
    ...
    const deleteOpcionAdicional = async (id_opcion) => {
        try {
            await axios.delete(`https://conection-ood1.onrender.com/api/opciones-adicionales/${id_opcion}`);
            fetchOpcionesAdicionales();
