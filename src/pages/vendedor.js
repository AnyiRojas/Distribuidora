...
const App = () => {
    ...
    const fetchPedidos = async () => {
        try {
            const response = await axios.get('https://conection-ood1.onrender.com/api/pedidos');
    ...
    const fetchItemsByPedido = async (id_pedido) => {
        try {
            const response = await axios.get(`https://conection-ood1.onrender.com/api/pedido/${id_pedido}/items`);
    ...
    const handleToggleProductStatus = async (idProducto) => {
        ...
        try {
            ...
            await axios.patch(`https://conection-ood1.onrender.com/api/productos/${idProducto}/estado`, { estado: nuevoEstado });
            fetchProductos();
    ...
    const handleTogglePedidoStatus = async (idPedido, nuevoEstado) => {
        if (!idPedido) return;
        try {
            await axios.patch(`https://conection-ood1.onrender.com/api/pedidos/${idPedido}/estado`, { nuevo_estado: nuevoEstado });
            fetchPedidos();
