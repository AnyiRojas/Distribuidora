...
const Login = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://conection-ood1.onrender.com/api/login', {
            ...
            if (usuario && usuario.documento) {
                ...
                const responseCarrito = await axios.post('https://conection-ood1.onrender.com/api/carrito/crear', {
                ...
                const responseDireccion = await axios.get(`https://conection-ood1.onrender.com/api/${usuario.documento}/direccion`);
