...
const ProductPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('https://conection-ood1.onrender.com/api/productos/fecha-especial/6'); // Cambia el ID según sea necesario
    ...
    const handleAddToCart = async (product) => {
        ...
        try {
            const response = await axios.post('https://conection-ood1.onrender.com/api/carrito/agregar', {
                documento,
